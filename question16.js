"use strict";
let guestlist = ['Amjad', 'Imdad', 'Arshad'];
// console.log(guestlist);
console.log(`\n The dinner table is bigger now so adding more guests\n`);
let newguest = ['Adeel', 'Kashif', 'Riaz']; //three more guest    
guestlist.unshift(newguest[0]); //added new guest to existing list at the position 0
console.log(guestlist);
let middleguest = Math.floor(guestlist.length / 2); //made two equal pieces of list to get middle position of the array
